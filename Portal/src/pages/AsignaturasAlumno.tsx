  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        ...
        // Cargar asignaturas con contenido disponible (ahora incluye las imágenes)
        ...
        if (response.ok) {
          ...
          setAsignaturas(result.asignaturas || []);
        }
          ...
          <div style={{ flex: 1, padding: 24, maxWidth: 1400, margin: "0 auto", width: "100%" }}>
            ...
            {loading && (
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                <div style={{ textAlign: "center", color: "#6b7280" }}>
                  ...
                  <div style={{ fontSize: "18px", fontWeight: 600, marginBottom: 12 }}>Cargando asignaturas...</div>
            ...
            {!loading && data && (
              <div>
                ...
                {/* Grid de asignaturas - 3 columnas */}
                <div style={{ 
                  display: "grid", 
                      ...
                      <div style={{ 
                        ...
                        <div>
                          ...
                          <p style={{
                            ...
                            {asignatura.descripcion ? formatDescription(asignatura.descripcion) : "Explora contenido diseñado para desarrollar tus habilidades y conocimientos. Aprende a tu ritmo con lecciones interactivas que se adaptan a tu estilo de aprendizaje y objetivos profesionales."}
                          </p>
                        </div>
                        
                        <button
                          onClick={() => nav(`/contenido-asignatura/${encodeURIComponent(asignatura.clase)}/${encodeURIComponent(asignatura.asignatura)}`)}
                          style={{
                            marginTop: "12px",
                            padding: "6px 12px",
