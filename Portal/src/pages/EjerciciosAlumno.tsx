...
export default function EjerciciosAlumno() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        ...
        // Cargar ejercicios con contenido disponible (ahora incluye las imágenes)
        ...
        if (response.ok) {
          ...
          setEjercicios(result.asignaturas || []);
        }
                ...
                <div style={{ 
                  ...
                  {ejercicios.map((ejercicio, index) => (
                    ...
                    >
                      ...
                      <img 
                        src={ejercicio.imagebase64}
                        alt={ejercicio.asignatura}
                        style={{
                          width: "80px",
                          height: "80px",
                          objectFit: "cover",
                      ...
                      <div style={{ 
                        ...
                        <div>
                          ...
                          <p style={{
                            ...
                            {ejercicio.descripcion ? formatDescription(ejercicio.descripcion) : "Explora contenido diseñado para desarrollar tus habilidades y conocimientos. Aprende a tu ritmo con lecciones interactivas que se adaptan a tu estilo de aprendizaje y objetivos profesionales."}
                          </p>
                        </div>
                        
                        <button
                          onClick={() => nav(`/ejercicios-asignatura/${encodeURIComponent(ejercicio.clase)}/${encodeURIComponent(ejercicio.asignatura)}`)}
                          style={{
                            marginTop: "12px",
                            padding: "6px 12px",
