...
export default function ContenidoAsignaturaAlumno() {
  ...
  const handleVerContenido = (unidad: any) => {
    // Navegar a la página de detalle del contenido
    nav(`/contenido/${clase}/${asignatura}/${unidad.unidad}`);
  };
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <nav style={{
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "8px", padding: "0 16px" }}>
            <button onClick={() => nav("/asignaturas-alumno")} style={{ width: "100%", padding: "12px 16px", border: "none", background: "rgba(146, 208, 80, 0.1)", textAlign: "left", cursor: "pointer", fontSize: "14px", fontWeight: 700, color: "#92D050", borderRadius: "8px", transition: "background 0.2s", display: "flex", alignItems: "center", gap: "12px" }}><i className="fa-solid fa-arrow-left" style={{ fontSize: "16px" }}></i>Volver</button>
          </div>

          {/* Botón de términos y cerrar sesión */}
